function user_job_setup()
	...
	gear.fastcast_jse_back =
		{ name = "Rudianos's Mantle", augments = { "HP+60", "Eva.+20 /Mag. Eva.+20", "HP+20", '"Fast Cast"+10' } }
	gear.enmity_jse_back = {
		name = "Rudianos's Mantle",
		augments = { "HP+60", "Eva.+20 /Mag. Eva.+20", "HP+20", "Enmity+10", "Chance of successful block +5" },
	}
